...
public class RuleIndexDefinition implements IndexDefinition {
  ...
  public static final String FIELD_RULE_EXTENSION_KEY = "key";
  public static final String FIELD_RULE_EXTENSION_RULE_TAGS = "tags";
  ...
  public void define(IndexDefinitionContext context) {
    ...
    ruleExtensionType.stringFieldBuilder(FIELD_RULE_EXTENSION_KEY).disableNorms().build();
    ruleExtensionType.stringFieldBuilder(FIELD_RULE_EXTENSION_RULE_TAGS).addSubFields(SEARCH_WORDS_ANALYZER).build();
